...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "InflationCoin-dns-seeder\n"
...
static const string mainnet_seeds[] = {"novaexchange.com/addnodes/IFLT/",
                                       ""};
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 11370), true);
  }
  do {
